...
public class LoginMain {
	public static void main(String args[]) {
		...
		System.out.println("Validation user1");
		status=loginService.validate(user1);
		System.out.println("Status : "+status);
		System.out.println("Validation user2");
		status=loginService.validate(user2);
		System.out.println("Status : "+status);
		System.out.println("Validation user3");
		status=loginService.validate(user3);
		System.out.println("Status : "+status);
	}
}
